...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Scenarios", "Scenarios for buggy car.", "The top 5 critical functionalities for buggy car are Register, Login, Traverse, V" +
                    "ote & Logout.\r\nThese have been combined in the following scenarios.", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void FirstTimeUser_RegistrationFlow()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("First time user - Registration Flow", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 8
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Headless")]
        public void CancelOutOfTheRegistrationFlow()
        {
            string[] tagsOfScenario = new string[] {
                    "test",
                    "alt",
                    "Headless"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Cancel out of the Registration flow", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 17
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("basic")]
        [NUnit.Framework.CategoryAttribute("Headless")]
        public void FirstVoteForFavoriteCar()
        {
            string[] tagsOfScenario = new string[] {
                    "test",
                    "basic",
                    "Headless"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("First Vote for favorite car", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 26
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("alt")]
        [NUnit.Framework.CategoryAttribute("Headless")]
        public void RevoteFavouriteCar()
        {
            string[] tagsOfScenario = new string[] {
                    "test",
                    "alt",
                    "Headless"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Revote favourite car", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 36
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("basic")]
        [NUnit.Framework.CategoryAttribute("Headless")]
        public void TraverseThroughPagesAndLogout()
        {
            string[] tagsOfScenario = new string[] {
                    "test",
                    "basic",
                    "Headless"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Traverse through pages and logout", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 45
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
